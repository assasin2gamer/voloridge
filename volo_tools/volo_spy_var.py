...
class VoloSpyVarAnalyzer:
    def __init__ (self):
        self.spy_data_path = "data/SPY_data.csv"
        self.spy_data = pd.read_csv(self.spy_data_path)
...
if __name__ == "__main__":
    forecaster = VoloSpyVarAnalyzer(spy_path="data/SPY_data.csv", data_dir="data")
